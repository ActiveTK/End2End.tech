...
<html lang="ja" dir="ltr">
  <head>
    ...
    <script>window.end2endtech={FileID:"<?=$FileID?>",FileName:atk.decode("<?=urlencode(basename( FileInfo["FileName"] ))?>").replace("+"," "),Encrypted:<?=(defined("DataEncrypted")?"true":"false")?>,Endpoint:atk.decode("<?=urlencode(APIEndPoint)?>"),EnableAPIAsSubDomain:<?=EnableAPIAsSubDomain?"true":"false"?>};</script>
