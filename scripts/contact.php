    ...
    <div id="main" class="main py-6 sm:py-8 lg:py-12">
      <div class="mx-auto max-w-screen-md px-4 md:px-8">
        ...
        <p class="mb-6 sm:text-lg md:mb-8">
          ...
          お問い合わせ頂いた内容は<a href="/privacy" target="_blank" class="text-blue-500">プライバシーポリシー</a>に基づき、サービスの改善に利用させて頂きます。
        </p>
...
また、お問い合わせの内容に機密情報が含まれる場合には、<a href="/pgp.asc" download="end2end_tech.asc" class="text-blue-500">PGP公開鍵</a>で暗号化して送信することもできます。</pre><br>
