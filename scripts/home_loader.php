        ...
        <div class="mb-16 grid grid-cols-2 gap-12 pt-10 md:grid-cols-4 lg:grid-cols-6 lg:gap-8 lg:pt-12">
          ...
          <div>
            ...
            <nav class="flex flex-col gap-4">
              ...
              <div>
                <a href="https://profile.activetk.jp/" class="text-gray-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600">Developer</a>
              </div>

              <div>
                <a href="https://github.com/ActiveTK/End2End.tech/blob/main/LICENSE" class="text-gray-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600">License</a>
              </div>
            </nav>
          </div>
